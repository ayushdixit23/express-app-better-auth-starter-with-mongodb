...
import { BETTER_AUTH_SECRET, BETTER_AUTH_URL, FRONTEND_URL, MONGO_URI } from "../utils/envConfig.js";
import { sendEmail } from "../lib/send-mail.js";
import { twoFactor } from "better-auth/plugins";

/**
 * Better Auth configuration with MongoDB
 */
export const auth = betterAuth({
  appName: "Express App",
  
  // MongoDB adapter using existing mongoose connection
